...
#contact
def contact():
    mess._show(title="Contact Me",message="dineshanandhan512@gmail.com")

#about
def about():
    mess._show(title="About",message="This project involves the development of an automated attendance system using face recognition technology for employees in an IT company. The system leverages AI and machine learning techniques to streamline and enhance the accuracy of employee attendance tracking, reducing reliance on traditional methods like manual logs or card swipes.     This Attendance System was developed and Designed by DINESH")
...
#frame_headder
fr_head1 = tkinter.Label(frame1, text="Register New Employer", fg="white",bg="black" ,font=('times', 17, ' bold ') )
fr_head1.place(x=0,y=0,relwidth=1)

fr_head2 = tkinter.Label(frame2, text="Mark Employers attendance", fg="white",bg="black" ,font=('times', 17, ' bold ') )
